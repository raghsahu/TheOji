...
public class AbsentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Connectivity.isNetworkAvailable(AbsentActivity.this)){
...
//        }
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(AbsentActivity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                server_url = "https://jntrcpl.com/theoji/index.php/Api/absent_list?attendance_id="+AttendenceID;
            ...
            if (output == null) {
                ...
                try {
                    ...
                    if (res.equals("true")) {
                        ...
                        p_a_adapter = new P_A_Adapter(AbsentActivity.this, P_A_List);
                        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(AbsentActivity.this);
...
//
                        ...
                        Toast.makeText(AbsentActivity.this, "no post update now, please refresh after some time!", Toast.LENGTH_LONG).show();
                    }
