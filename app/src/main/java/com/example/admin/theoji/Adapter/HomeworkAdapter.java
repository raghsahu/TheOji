...
import com.example.admin.theoji.HomeworkActivity;
...
import static com.example.admin.theoji.HomeworkActivity.HomeworkHashMap;
       ...
       Picasso.get().load("https://jntrcpl.com/theoji/uploads/"+homeworkModel.getImagename())
        ...
        viewHolder.img2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (homeworkModel.getImagename().length()!=0)
                {
                    Picasso.get().load("https://jntrcpl.com/theoji/uploads/"+homeworkModel.getImagename())
                            .into(dialogImage);
                    d.show();
